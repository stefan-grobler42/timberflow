...
class EnhancedPamirParser {
    constructor() {
        ...
        this.stockMappings = {
            ...
            // Hanger mappings  
            'HANGER_GENERAL': 'HNG-STD',
            'HANGER_TORSIONAL': 'HNG-TOR',
            
            // Fastener mappings
            'NAILS_75MM': 'NAIL-75',
            'NAILS_90MM': 'NAIL-90',
            'SCREWS_12X65': 'SCREW-12X65'
        };
    ...
    initializeMaterialContainers() {
        return {
            bracing: {
                name: 'Bracing Package',
                items: [
                    {
                        group: 'Top Chord Bracing',
                        stockCode: '38x114',
                        formula: 'TOP_CHORD_BRACING_LENGTH',
                        nails: { code: 'NAIL-75', formula: 'TOP_CHORD_NAILS' }
                    },
                    {
                        group: 'Web Bracing', 
                        stockCode: '38x76',
                        formula: 'WEB_BRACING_LENGTH',
                        nails: { code: 'NAIL-75', formula: 'WEB_BRACING_NAILS' }
                    },
                    {
                        group: 'Bottom Chord Bracing',
                        stockCode: '38x76',
                        formula: 'BOTTOM_CHORD_BRACING_LENGTH', 
                        nails: { code: 'NAIL-75', formula: 'BOTTOM_CHORD_NAILS' }
                    }
                ]
            },
            battens: {
                ...
                items: [
                    {
                        ...
                        nails: { code: 'NAIL-90', formula: 'BATTEN_NAILS' }
                    }
                ]
            },
            flashings: {
